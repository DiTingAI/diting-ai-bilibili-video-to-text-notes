...
<p align="center">
  不用手动截图、不用逐帧暂停抄字幕、不用排版。Fork 本仓库配置自己的 Key，或直接<a href="https://github.com/{{REPO_FULL_NAME}}/issues/new?template=%F0%9F%8E%AF_request_lecture_notes.md">提交 Issue</a>试用（每天限 2 次），剩下的全自动完成。
</p>
